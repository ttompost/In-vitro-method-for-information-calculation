function [input_current, input_theory, hidden_state] = make_input_experiments(baseline, amplitude_scaling, ron, roff, mean_firing_rate, sampling_rate, duration, seed)
